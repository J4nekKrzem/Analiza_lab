...
employee2 = Employee("Alice", "Smith", "2022-02-01", "1985-08-20", "City2", "Street2", "54321", "444-555-666")
...
book5 = Book(library2, "2021-05-01", "Author5", "Surname5", 220)

order1 = Order(employee1, "Student1", [book1, book2, book3], "2023-01-10")
order2 = Order(employee2, "Student2", [book4, book5], "2023-02-15")
